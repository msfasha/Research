...
public class OntologyInterface {
    ...
    OWLDataFactory df;
    IRI ontologyIRI;
    ReasonerInterface reasoner;

    public String OntologyFile;

    public OntologyInterface(String paraOntologyFile) throws OWLOntologyStorageException, OWLOntologyCreationException, Exception {

        OntologyFile = paraOntologyFile;
