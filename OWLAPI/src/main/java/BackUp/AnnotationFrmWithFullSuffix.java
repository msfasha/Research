 ...
 */
public class AnnotationFrmWithFullSuffix extends javax.swing.JFrame {
    ...
    public AnnotationFrmWithFullSuffix() throws OWLOntologyStorageException, OWLOntologyCreationException, ClassNotFoundException, SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        CmdRevertjTextAreaExpandedTextandPOS = new javax.swing.JButton();
        CmdRevertjTextAreaCorrectedTextAndPOS = new javax.swing.JButton();
        ...
        CmdRevertjTextAreaExpandedTextandPOS.setText("Revert");
        CmdRevertjTextAreaExpandedTextandPOS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CmdRevertjTextAreaExpandedTextandPOSActionPerformed(evt);
            }
        });
        jPanelPOSTags.add(CmdRevertjTextAreaExpandedTextandPOS, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 120, 110, 20));

        CmdRevertjTextAreaCorrectedTextAndPOS.setText("Revert");
        CmdRevertjTextAreaCorrectedTextAndPOS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CmdRevertjTextAreaCorrectedTextAndPOSActionPerformed(evt);
            }
        });
        jPanelPOSTags.add(CmdRevertjTextAreaCorrectedTextAndPOS, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 20, 110, 20));
    ...
    private void jTableConceptsListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableConceptsListMouseClicked
        ChangeConceptArgumentsSettings();
    }//GEN-LAST:event_jTableConceptsListMouseClicked
...
//        }
    ...
    private void jToggleButtonPOSPronounActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonPOSPronounActionPerformed
        UpdateAnnotation();
    }//GEN-LAST:event_jToggleButtonPOSPronounActionPerformed
...
//        }
    ...
    private void jToggleButtonPOSPrepositinoMENActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonPOSPrepositinoMENActionPerformed
        UpdateAnnotation();
    }//GEN-LAST:event_jToggleButtonPOSPrepositinoMENActionPerformed
    ...
    private void jToggleButtonPOSCordinatingConjuctionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonPOSCordinatingConjuctionActionPerformed
        UpdateAnnotation();
    }//GEN-LAST:event_jToggleButtonPOSCordinatingConjuctionActionPerformed
    ...
    private void jToggleButtonPOSPrepositinoElAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonPOSPrepositinoElAActionPerformed
        UpdateAnnotation();
    }//GEN-LAST:event_jToggleButtonPOSPrepositinoElAActionPerformed
    ...
    private void jToggleButtonParticleLAMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonParticleLAMActionPerformed
        UpdateAnnotation();
    }//GEN-LAST:event_jToggleButtonParticleLAMActionPerformed
    ...
    private void CmdRevertjTextAreaExpandedTextandPOSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CmdRevertjTextAreaExpandedTextandPOSActionPerformed
        jTextAreaExpandedTextandPOS.setText(OriginalExpandedTextandPOS);
    }//GEN-LAST:event_CmdRevertjTextAreaExpandedTextandPOSActionPerformed

    private void CmdRevertjTextAreaCorrectedTextAndPOSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CmdRevertjTextAreaCorrectedTextAndPOSActionPerformed
        jTextAreaCorrectedTextAndPOS.setText(OriginalCorrectedTextAndPOS);
    }//GEN-LAST:event_CmdRevertjTextAreaCorrectedTextAndPOSActionPerformed
...
//        sentenceRecord.setSemanticTextAndPos(jTextAreaSemanticTextandPOS.getText());
    ...
    private void PopulateConceptTable(String paraOntologyFilePath) {
        ...
        try {
            ...
            Logger.getLogger(POSandRelationsAnnotationFrm.class
    ...
    private void UpdateAnnotation() {
        ...
        String arabicToken = Utility.Globals.StripPOSTagsKeepText(UserSelectedPOSSegment);
        ...
        CurrentjTextArea.setText(sb.toString());

        jLabelEnd.setText(String.valueOf(SelectionEndPosition));
        UserSelectedPOSSegment = CurrentjTextArea.getText().substring(SelectionStartPosition, SelectionEndPosition);
    }
...
//        }
        ...
        if (paraString.contains(POSTagDefinition.Suffix_SUBJECT)) {
            jToggleButtonSuffixSubject.setSelected(true);
        }

        if (paraString.contains(POSTagDefinition.Suffix_OBJECT)) {
            jToggleButtonSuffixObject.setSelected(true);
        }

        if (paraString.contains(POSTagDefinition.Suffix_POSS)) {
            jToggleButtonSuffixPossession.setSelected(true);
        }

        if (paraString.contains(POSTagDefinition.Suffix_SINGLE)) {
            jToggleButtonSuffixSingle.setSelected(true);
        }

        if (paraString.contains(POSTagDefinition.Suffix_DUAL)) {
            jToggleButtonSuffixDual.setSelected(true);
        }

        if (paraString.contains(POSTagDefinition.Suffix_GROUP)) {
            jToggleButtonSuffixGroup.setSelected(true);
        }

        if (paraString.contains(POSTagDefinition.Suffix_MASCULINE)) {
            jToggleButtonSuffixMasculine.setSelected(true);
        }

        if (paraString.contains(POSTagDefinition.Suffix_FEMININE)) {
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(POSandRelationsAnnotationFrm.class
    ...
    private javax.swing.JButton CmdRevertjTextAreaCorrectedTextAndPOS;
    private javax.swing.JButton CmdRevertjTextAreaExpandedTextandPOS;
