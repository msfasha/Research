The CRC/Hash hypothesis - I have a hypthesis that the Muqatta'at (المقطعات - the disjointed letters at the start of certain surahs like ا ل م, كهيعص) in Quran servs as some kind of checksum is particularly intriguing. 
